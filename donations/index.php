...
<head>
    ...
    <title>CodingAssessment - Donations</title>
...
<body>
    ...
    <div id="side-navigation-menu" class="sidenav">
        ...
        <a href="#" onclick="closeNav()">Donations</a>
    ...
    <div id="basket">
        ...
        <div class="page-title-container-4">
            <div class="page-title-content">Donations</div>
        </div>
...
Student ID: Redacted
 -->
        ...
        <div class="container">
            ...
            <form action="../donations/process_donation.php" method="POST">
