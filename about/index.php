...
<body>
    ...
    <div id="basket">
        ...
        <div class="page-title-container-5">
 ...
 -->
        ...
        <div class="container">
            ...
            <div class="hidden-div"></div>
                <h2>Who We Are</h2>
                <p>We are a interactive learning platform developed to help all CSS and HTML learners.</p>
                <p>We design a clear and user-friendly interface with straightforward functionality.</p>
                <h2>What We Do</h2>
                <p>Our goal is to aspiring web developers who are learning coding.</p>
                <p>We provides a wide range of materials for learners.</p>
                <h2>Our Vision</h2>
                <p>To provide a platform with learning and assessment possibilities for all users.</p>
                <p>To enable users to select assessments from various areas, with quizzes suited to their unique requirements and ability levels.</p>
                <h2>Our Mission</h2>
                <p>To create a completely responsive and accessible online application that works across many devices and accommodates users of various abilities.</p>
                <p>To include interactive quizzes, multimedia components, and fast feedback, ensuring that users remain interested while learning.</p>
