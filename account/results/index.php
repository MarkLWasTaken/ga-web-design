...
<head>
    ...
    <title>CodingAssessment - Account Results</title>

    <!-- Cascading Style Sheets -->
    <link href="../../css/styles.css" rel="stylesheet">
    <link href="../../css/dropdown-menu.css" rel="stylesheet">
    <link href="../../css/account-results.css" rel="stylesheet">
...
<body>
    ...
    <div id="side-navigation-menu" class="sidenav">
        ...
        if (isset($_SESSION['email_address'])) {
            ...
            echo "<a href='#' onclick='closeNav()'>Results</a>";
    ...
    <div id="basket">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            if (isset($_SESSION['email_address'])) {
                                ...
                                echo "<a class='menu' href='#'>Results</a>";
        ...
        <h1 class="page-title">Account Results</h1>
        ...
        <div id="contents-container">
            <div id="content1" class="content">
                <br>
                <img class="content-image" src="../../images/desktop-computer-svgrepo-com.svg" alt="Image #1">
                <br>
                Content 1
            </div>
        </div>
