...
<body>
    ...
    <div id="basket">
        ...
        <div class="page-title-container-3">
            <div class="page-title-content">Tips</div>
        </div>
        ...
        <div class="tips-container">
            <table class="hidden-table">
                <tr>
                    <td class="quiz-title">Tip #1 - Tip name here</td>
                </tr>
                <tr>
                    <td class="quiz-description">Tip description here.</td>
                </tr>
            </table>
        </div>
        ...
        <div class="tips-container">
            <table class="hidden-table">
                <tr>
                    <td class="quiz-title">Tip #2 - Tip name here</td>
                </tr>
                <tr>
                    <td class="quiz-description">Tip description here.</td>
                </tr>
        ...
        <div class="tips-container">
            <table class="hidden-table">
                <tr>
                    <td class="quiz-title">Tip #3 - Tip name here</td>
                </tr>
                <tr>
                    <td class="quiz-description">Tip description here.</td>
                </tr>
